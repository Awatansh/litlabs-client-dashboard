...
export default function OverviewPage() {
  ...
  return (
    <div className="max-w-6xl">
      ...
      {pendingApprovals > 0 && (
        <div className="mb-6 glass-card p-4 rounded-2xl border border-amber-500/20 bg-amber-500/5 fade-in-up">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-amber-500/20 flex items-center justify-center flex-shrink-0">
              <span className="text-amber-400">⚠️</span>
            </div>
            <div className="flex-1">
              <p className="text-sm font-semibold text-amber-300">{pendingApprovals} item(s) need your attention</p>
              <p className="text-xs text-amber-400/70">Work is waiting for your approval to proceed.</p>
            </div>
            <Link
              href="/approvals"
              className="text-xs font-semibold text-amber-400 hover:text-amber-300 px-3 py-1.5 rounded-lg bg-amber-500/10 hover:bg-amber-500/20 transition-all"
            >
              Review Now →
            </Link>
          </div>
